...
<head>
  ...
  <style>
    ...
    /* Ensure text color is white when background is dark */
.right_come {
  color: white;
}

/* Optional: if you want to target specifically when the background is dark */
.dark-mode .right_come {
  color: white;
}
...
<section class="py-16 lg:px-[10%] bg-[#000000] px-[4%] md:px-[10%]">
      ...
      <div class="bottom_come capitalize mb-10 px-8 text-white ">
        <a href="index.php"> <i class="fa-solid fa-arrow-left mr-1 text-blue-400"></i> back to </a>
      </div>
        <div class="px-4">
        <?php
        $post_id = $_GET['id'];
