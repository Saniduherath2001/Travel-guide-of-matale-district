<?php
require 'db.php';
$db = mysqli_connect('localhost', 'root', '', 'travel_guide') or die('database is not connected !');
    ...
    <div class=" bg-[#0a0a0a] flex flex-col w-full max-w-4xl md:h-56  rounded-lg shadow-lg overflow-hidden md:flex-row my-10">
      <div class="md:flex items-center justify-center md:w-1/2 ">
          <div class="py-6 px-8 md:py-0 text-center md:text-left ">
              ...
              <p class="mt-2 text-sm font-light text-gray-400 md:text-gray-400 capitalize">by becoming a member of our blog. you have access places and contents</p>
          </div>
      </div>
