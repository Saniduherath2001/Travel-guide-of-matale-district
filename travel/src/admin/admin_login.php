...
<body class="bg-[#000000]">
  ...
  <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
      <a href="#" class="flex items-center mb-6 text-2xl font-semibold text-gray-900">
        <img class="cursor-default h-[55px] m-auto mb-10" src="../assets/img/s.png" alt="logo">
      </a>
      <div class="w-full rounded-lg shadow border-none outline-none md:mt-0 sm:max-w-md xl:p-0 bg-[#0a0a0a]">
          <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
              ...
              <form class="space-y-4 md:space-y-6"  method="post" action="">
                  <div>
                      <label for="username" class="block mb-2 text-lh font-medium text-white capitalize">admin username</label>
